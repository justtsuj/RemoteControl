...
static word FT0[256] = { FT };
#undef V

#define V(a,b,c,d) 0x##d##a##b##c
static word FT1[256] = { FT };
#undef V

#define V(a,b,c,d) 0x##c##d##a##b
static word FT2[256] = { FT };
#undef V

#define V(a,b,c,d) 0x##b##c##d##a
static word FT3[256] = { FT };
#undef V
...
#define V(a,b,c,d) 0x##a##b##c##d
static word RT0[256] = { RT };
#undef V

#define V(a,b,c,d) 0x##d##a##b##c
static word RT1[256] = { RT };
#undef V

#define V(a,b,c,d) 0x##c##d##a##b
static word RT2[256] = { RT };
#undef V

#define V(a,b,c,d) 0x##b##c##d##a
static word RT3[256] = { RT };
#undef V
...
int aes_set_key( struct aes_context *ctx, byte *key, int nbits )
{
    ...
    case 256:
        ...
        for( i = 0; i < 7; i++, RK += 8 )
        {
            ...
            RK[12] = RK[4] ^
                        ( FSb[ (byte) ( RK[11] >> 24 ) ] << 24 ) ^
                        ( FSb[ (byte) ( RK[11] >> 16 ) ] << 16 ) ^
                        ( FSb[ (byte) ( RK[11] >>  8 ) ] <<  8 ) ^
                        ( FSb[ (byte) ( RK[11]       ) ]       );
    ...
    {
        RK[0] = RT0[ FSb[ (byte) ( RK[0] >> 24 ) ] ] ^
                RT1[ FSb[ (byte) ( RK[0] >> 16 ) ] ] ^
                RT2[ FSb[ (byte) ( RK[0] >>  8 ) ] ] ^
                RT3[ FSb[ (byte) ( RK[0]       ) ] ];

        RK[1] = RT0[ FSb[ (byte) ( RK[1] >> 24 ) ] ] ^
                RT1[ FSb[ (byte) ( RK[1] >> 16 ) ] ] ^
                RT2[ FSb[ (byte) ( RK[1] >>  8 ) ] ] ^
                RT3[ FSb[ (byte) ( RK[1]       ) ] ];

        RK[2] = RT0[ FSb[ (byte) ( RK[2] >> 24 ) ] ] ^
                RT1[ FSb[ (byte) ( RK[2] >> 16 ) ] ] ^
                RT2[ FSb[ (byte) ( RK[2] >>  8 ) ] ] ^
                RT3[ FSb[ (byte) ( RK[2]       ) ] ];

        RK[3] = RT0[ FSb[ (byte) ( RK[3] >> 24 ) ] ] ^
                RT1[ FSb[ (byte) ( RK[3] >> 16 ) ] ] ^
                RT2[ FSb[ (byte) ( RK[3] >>  8 ) ] ] ^
                RT3[ FSb[ (byte) ( RK[3]       ) ] ];
    }
...
{
    word *RK, X0, X1, X2, X3, Y0, Y1, Y2, Y3;
...
{                                               \
    RK += 4;                                    \
                                                \
    X0 = RK[0] ^ FT0[ (byte) ( Y0 >> 24 ) ] ^  \
                 FT1[ (byte) ( Y1 >> 16 ) ] ^  \
                 FT2[ (byte) ( Y2 >>  8 ) ] ^  \
                 FT3[ (byte) ( Y3       ) ];   \
                                                \
    X1 = RK[1] ^ FT0[ (byte) ( Y1 >> 24 ) ] ^  \
                 FT1[ (byte) ( Y2 >> 16 ) ] ^  \
                 FT2[ (byte) ( Y3 >>  8 ) ] ^  \
                 FT3[ (byte) ( Y0       ) ];   \
                                                \
    X2 = RK[2] ^ FT0[ (byte) ( Y2 >> 24 ) ] ^  \
                 FT1[ (byte) ( Y3 >> 16 ) ] ^  \
                 FT2[ (byte) ( Y0 >>  8 ) ] ^  \
                 FT3[ (byte) ( Y1       ) ];   \
                                                \
    X3 = RK[3] ^ FT0[ (byte) ( Y3 >> 24 ) ] ^  \
                 FT1[ (byte) ( Y0 >> 16 ) ] ^  \
                 FT2[ (byte) ( Y1 >>  8 ) ] ^  \
                 FT3[ (byte) ( Y2       ) ];   \
}
    ...
    X0 = RK[0] ^ ( FSb[ (byte) ( Y0 >> 24 ) ] << 24 ) ^
                 ( FSb[ (byte) ( Y1 >> 16 ) ] << 16 ) ^
                 ( FSb[ (byte) ( Y2 >>  8 ) ] <<  8 ) ^
                 ( FSb[ (byte) ( Y3       ) ]       );

    X1 = RK[1] ^ ( FSb[ (byte) ( Y1 >> 24 ) ] << 24 ) ^
                 ( FSb[ (byte) ( Y2 >> 16 ) ] << 16 ) ^
                 ( FSb[ (byte) ( Y3 >>  8 ) ] <<  8 ) ^
                 ( FSb[ (byte) ( Y0       ) ]       );

    X2 = RK[2] ^ ( FSb[ (byte) ( Y2 >> 24 ) ] << 24 ) ^
                 ( FSb[ (byte) ( Y3 >> 16 ) ] << 16 ) ^
                 ( FSb[ (byte) ( Y0 >>  8 ) ] <<  8 ) ^
                 ( FSb[ (byte) ( Y1       ) ]       );

    X3 = RK[3] ^ ( FSb[ (byte) ( Y3 >> 24 ) ] << 24 ) ^
                 ( FSb[ (byte) ( Y0 >> 16 ) ] << 16 ) ^
                 ( FSb[ (byte) ( Y1 >>  8 ) ] <<  8 ) ^
                 ( FSb[ (byte) ( Y2       ) ]       );
...
{                                               \
    RK += 4;                                    \
                                                \
    X0 = RK[0] ^ RT0[ (byte) ( Y0 >> 24 ) ] ^  \
                 RT1[ (byte) ( Y3 >> 16 ) ] ^  \
                 RT2[ (byte) ( Y2 >>  8 ) ] ^  \
                 RT3[ (byte) ( Y1       ) ];   \
                                                \
    X1 = RK[1] ^ RT0[ (byte) ( Y1 >> 24 ) ] ^  \
                 RT1[ (byte) ( Y0 >> 16 ) ] ^  \
                 RT2[ (byte) ( Y3 >>  8 ) ] ^  \
                 RT3[ (byte) ( Y2       ) ];   \
                                                \
    X2 = RK[2] ^ RT0[ (byte) ( Y2 >> 24 ) ] ^  \
                 RT1[ (byte) ( Y1 >> 16 ) ] ^  \
                 RT2[ (byte) ( Y0 >>  8 ) ] ^  \
                 RT3[ (byte) ( Y3       ) ];   \
                                                \
    X3 = RK[3] ^ RT0[ (byte) ( Y3 >> 24 ) ] ^  \
                 RT1[ (byte) ( Y2 >> 16 ) ] ^  \
                 RT2[ (byte) ( Y1 >>  8 ) ] ^  \
                 RT3[ (byte) ( Y0       ) ];   \
}
    ...
    X0 = RK[0] ^ ( RSb[ (byte) ( Y0 >> 24 ) ] << 24 ) ^
                 ( RSb[ (byte) ( Y3 >> 16 ) ] << 16 ) ^
                 ( RSb[ (byte) ( Y2 >>  8 ) ] <<  8 ) ^
                 ( RSb[ (byte) ( Y1       ) ]       );

    X1 = RK[1] ^ ( RSb[ (byte) ( Y1 >> 24 ) ] << 24 ) ^
                 ( RSb[ (byte) ( Y0 >> 16 ) ] << 16 ) ^
                 ( RSb[ (byte) ( Y3 >>  8 ) ] <<  8 ) ^
                 ( RSb[ (byte) ( Y2       ) ]       );

    X2 = RK[2] ^ ( RSb[ (byte) ( Y2 >> 24 ) ] << 24 ) ^
                 ( RSb[ (byte) ( Y1 >> 16 ) ] << 16 ) ^
                 ( RSb[ (byte) ( Y0 >>  8 ) ] <<  8 ) ^
                 ( RSb[ (byte) ( Y3       ) ]       );

    X3 = RK[3] ^ ( RSb[ (byte) ( Y3 >> 24 ) ] << 24 ) ^
                 ( RSb[ (byte) ( Y2 >> 16 ) ] << 16 ) ^
                 ( RSb[ (byte) ( Y1 >>  8 ) ] <<  8 ) ^
                 ( RSb[ (byte) ( Y0       ) ]       );
